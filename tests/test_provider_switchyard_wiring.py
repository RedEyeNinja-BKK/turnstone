...
def test_every_gated_name_is_constructible_by_the_factory() -> None:
    ...
    from turnstone.console.server import _MODEL_PROVIDERS
    from turnstone.core.model_turn import EXTRA_BODY_PROVIDERS, EXTRA_HEADERS_PROVIDERS

    gated = set(_MODEL_PROVIDERS) | set(EXTRA_BODY_PROVIDERS) | set(EXTRA_HEADERS_PROVIDERS)
...
def test_switchyard_lanes_take_the_same_operator_pins_as_the_name_they_replace() -> None:
    ...
    assert PROVIDER_NAME in EXTRA_HEADERS_PROVIDERS
